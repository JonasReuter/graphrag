...
## contradictions
(Optional) Generated by entity resolution and confidence scoring workflows. Records semantic conflicts, duplicate merges, and evidence contradictions detected across the knowledge graph. Only present when entity resolution or confidence scoring is enabled.

| name              | type  | description |
| ----------------- | ----- | ----------- |
| relation_type     | str   | Nature of the contradiction. One of `same_as` (entity merge), `possibly_same_as` (probable duplicate), `contradicts` (conflicting evidence), or `supersedes` (updated/replaced record). |
| subject_a_type    | str   | Type of the first subject. One of `entity`, `relationship`, or `evidence`. |
| subject_b_type    | str   | Type of the second subject. One of `entity`, `relationship`, or `evidence`. |
| subject_a_id      | str   | ID of the first subject. |
| subject_b_id      | str   | ID of the second subject. |
| description       | str   | Optional human-readable explanation of the contradiction. |
| confidence        | float | Confidence score for the contradiction, between 0.0 and 1.0. |
| detection_method  | str   | How the contradiction was found. One of `embedding_similarity` (vector-based) or `llm_verified` (LM-confirmed). |
| attributes        | dict  | Optional bag of additional metadata (e.g. merged entity IDs, similarity scores). |
