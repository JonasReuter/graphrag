...
-Goal-
Given a text document that is potentially relevant to this activity and a list of entity types, identify all entities of those types from the text and all relationships among the identified entities. For relationships, also capture the time period during which the relationship held, if explicitly stated.
...
- temporal_scope: ONLY if the text explicitly states when this relationship started, ended, or applies to a specific period. Examples: "2020-2023", "since January 2024", "formerly", "until March 2025". Leave EMPTY if the text does not explicitly mention a time period for this relationship. Do NOT infer a date from the document date.
...
##
("relationship"<|>VISION HOLDINGS<|>TECHGLOBAL<|>Vision Holdings formerly owned TechGlobal<|>5<|>until 2014)
<|COMPLETE|>
